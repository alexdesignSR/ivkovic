...
let config = (function(){
	...
	return {
		...
		/***********************************************************************/
		text_domain: '' || project_name, // Example: 'ivkovic' #lowercase, separated by underscore or dash ( _ or - )
		packageName: '' || project_name, // Example: 'Ivkovic package' #Capitalized
